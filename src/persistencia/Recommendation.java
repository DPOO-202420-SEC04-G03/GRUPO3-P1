...
public class Recommendation {
    ...
    public void req1CrearLP() {
        ...
        if (!this.actividades.isEmpty()) {
            actividadesEnLP.add(this.actividades.values().iterator().next()); // Añade una actividad de ejemplo existente
        }
    
        // Crear instancia de LearningPath con los datos de prueba
        LearningPath nuevoLP = new LearningPath(titulo, descripcion, actividadesEnLP, nivelDificultad, id_LP, fechaCreacion, version, objetivo);
